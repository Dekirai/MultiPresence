...
namespace MultiPresence.Presence
{
    public class CBNT
    {
        ...
        public static void DoAction()
        {
            ...
            PresenceRuntime.Start(nameof(CBNT), "CrashBandicootNSaneTrilogy", RPC);
        }
        ...
        private static void GetPID()
        {
            try
            {
                ProcessMonitor.TryAttach("CrashBandicootNSaneTrilogy");
            }
            catch
            {
                //nothing?
        ...
        {
            if (ProcessMonitor.IsRunning("CrashBandicootNSaneTrilogy"))
            {
